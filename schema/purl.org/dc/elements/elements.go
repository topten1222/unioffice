...
package elements ;import (_e "encoding/xml";_be "fmt";_g "github.com/topten1222/unioffice";_c "github.com/topten1222/unioffice/common/logger";);func (_ed *ElementContainer )UnmarshalXML (d *_e .Decoder ,start _e .StartElement )error {_dc :for {_ec ,_cd :=d .Token ();
