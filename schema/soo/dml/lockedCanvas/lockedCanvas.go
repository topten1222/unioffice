...
start .Name .Local ="\u006c\u006f\u0063k\u0065\u0064\u0043\u0061\u006e\u0076\u0061\u0073";return _g .CT_GvmlGroupShape .MarshalXML (e ,start );};type LockedCanvas struct{_bc .CT_GvmlGroupShape };func (_e *LockedCanvas )UnmarshalXML (d *_b .Decoder ,start _b .StartElement )error {_e .CT_GvmlGroupShape =*_bc .NewCT_GvmlGroupShape ();
for {_bb ,_cc :=d .Token ();if _cc !=nil {return _dg .Errorf ("\u0070a\u0072\u0073\u0069\u006e\u0067\u0020\u004c\u006f\u0063\u006b\u0065d\u0043\u0061\u006e\u0076\u0061\u0073\u003a\u0020\u0025\u0073",_cc );};if _cf ,_f :=_bb .(_b .EndElement );_f &&_cf .Name ==start .Name {break ;
};};return nil ;};

// Validate validates the LockedCanvas and its children
func (_ee *LockedCanvas )Validate ()error {return _ee .ValidateWithPath ("\u004c\u006f\u0063k\u0065\u0064\u0043\u0061\u006e\u0076\u0061\u0073");};func NewLockedCanvas ()*LockedCanvas {_cg :=&LockedCanvas {};_cg .CT_GvmlGroupShape =*_bc .NewCT_GvmlGroupShape ();
return _cg ;};func init (){_c .RegisterConstructor ("h\u0074\u0074\u0070\u003a\u002f\u002f\u0073\u0063\u0068\u0065\u006d\u0061\u0073\u002e\u006f\u0070\u0065\u006e\u0078\u006d\u006c\u0066\u006f\u0072\u006d\u0061t\u0073.\u006f\u0072\u0067\u002fd\u0072\u0061w\u0069\u006e\u0067\u006d\u006c\u002f\u0032\u0030\u0030\u0036\u002f\u006c\u006f\u0063\u006b\u0065\u0064\u0043\u0061\u006e\u0076\u0061\u0073","\u006c\u006f\u0063k\u0065\u0064\u0043\u0061\u006e\u0076\u0061\u0073",NewLockedCanvas );
};